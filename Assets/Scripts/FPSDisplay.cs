...
public class FPSDisplay : MonoBehaviour {
	...
	void Update () {
		Display (hightestFPSText, fpsCounter.HighestFPS);
		Display (lowestFPSText, fpsCounter.LowestFPS);
		Display (fpsText, fpsCounter.AverageFPS);
	}
